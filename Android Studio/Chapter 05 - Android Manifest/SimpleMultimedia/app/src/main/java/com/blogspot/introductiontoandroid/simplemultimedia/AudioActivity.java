package com.blogspot.introductiontoandroid.simplemultimedia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                values.put(MediaColumns.DISPLAY_NAME, "The Audio File You Recorded In Media App");
                ...
                Uri audioUri = getContentResolver().insert(MediaStore.Audio.Media.INTERNAL_CONTENT_URI, values);
                if (audioUri == null) {
