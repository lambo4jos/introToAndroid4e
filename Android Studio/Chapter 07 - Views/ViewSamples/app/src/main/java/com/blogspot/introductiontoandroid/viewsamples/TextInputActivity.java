package com.blogspot.introductiontoandroid.viewsamples;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Toast.makeText(TextInputActivity.this, "1 = "+text1.getText()+ " 2 = " + text2.getText() + "\n spinner = "+text_sel.getText(), Toast.LENGTH_SHORT).show();
			}
		});
        ...
        text_filtered.setFilters(new InputFilter[] { new InputFilter.AllCaps(), new InputFilter.LengthFilter(2) });   
    }
}