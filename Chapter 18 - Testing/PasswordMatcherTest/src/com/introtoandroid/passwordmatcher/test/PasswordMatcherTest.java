package com.introtoandroid.passwordmatcher.test;

import com.introtoandroid.passwordmatcher.PasswordMatcherActivity;
import com.introtoandroid.passwordmatcher.R;
...
public class PasswordMatcherTest extends
	...
	public void testMatchingPasswords() {
		...
		TouchUtils.tapView(this, matchingPassword);
		sendKeys(GOOD_PASSWORD);
	...
	public void testNotEqualPasswords() {
		...
		assertTrue("Passwords should not match", (good != bad));
